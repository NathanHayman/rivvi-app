...
import { Button, Copy, LoadingSpinner, Tick } from "@phunq/ui";
  ...
  return (
    <div className="relative flex w-full rounded-md shadow-sm">
      ...
      <input
        ...
        autoComplete="off"
        onPaste={(e) => {
          // replace http://phunq.sh/ or https://phunq.sh/ with nothing
          const pastedText = e.clipboardData
            .getData("text")
            .replace(/https?:\/\/phunq\.sh\//, "");
...
const BanButton = () => {
  const { pending } = useFormStatus();
  return <Button text="Confirm Ban" loading={pending} variant="destructive" />;
};
