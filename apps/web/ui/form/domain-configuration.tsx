...
export const InlineSnippet = ({
  ...
  return (
    <span
      className={cn(
        "text-blue-12 dark:bg-blue-12 font-mo11 inline-block rounded-md bg-blue-100 px-1 py-0.5 dark:text-blue-100",
        className,
      )}
    >
      {children}
...
export default function DomainConfiguration({ domain }: { domain: string }) {
  ...
  const { status, domainJson } =
    useDomainStatus({ domain, workspaceSlug }) || {};
  ...
  return (
    <div className="border-slate-6 border-t px-10 pb-5 pt-7 ">
