import { NumberTooltip, useRouterStuff } from "@phunq/ui";
import { nFormatter, PAGINATION_LIMIT } from "@phunq/utils";
import { ChevronLeft, ChevronRight } from "lucide-react";
import { useSearchParams } from "next/navigation";

import useFunnelsCount from "@/lib/swr/use-sites-count";
...
export default function SitePagination() {
	...
	const { data: count } = useFunnelsCount();
