...
export default function OverviewStats() {
	...
	return (
		<div className="grid gap-6 sm:grid-cols-2 bg-background">
			<Card className="dark:!bg-background bg-background">
			...
			<Card className="dark:!bg-background bg-background">
				<Text>New Visitors</Text>
				<Flex
					className="space-x-3 truncate"
					justifyContent="start"
					alignItems="baseline"
				>
					<Metric className="font-cal">70,408</Metric>
					<BadgeDelta
						deltaType="moderateIncrease"
						className="dark:bg-green-900 dark:bg-opacity-50 dark:text-green-400"
					>
