...
export default function DeletePageForm({ pageName }: { pageName: string }) {
	...
	return (
		<form
			action={async (data: FormData) =>
				...
				deletePage(data, id, "delete").then((res) => {
					if (res.error) {
		...
		>
			<div className="relative flex flex-col space-y-4 p-5 sm:p-10">
				<h2 className="font-cal text-xl dark:text-white">Delete Page</h2>
				<p className="text-sm text-stone-500 dark:text-stone-400">
					Deletes your page permanently. Type in the name of your page{" "}
					<b>{pageName}</b> to confirm.
				</p>
