...
export default function RebrandEmail({
	...
	return (
		<Html>
			<Head />
			<Preview>
				Today, we&apos;re thrilled to announce our rebrand. Dub.sh is now
				Dub.co.
			</Preview>
			<Tailwind>
				<Body className="mx-auto my-auto bg-white font-sans">
					<Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
						...
						<Text className="text-sm leading-6 text-black">
							My name is Steven, and I&apos;m the founder of Dub. Today, I have
						...
						<Text className="text-sm leading-6 text-black">
							Moving forward, we&apos;ll also be sending product update emails
							from <strong>ship.dub​.co</strong> instead of{" "}
							<strong>ship.dub​.sh</strong>. We&apos;d appreciate it if you can
							add <strong>ship.dub​.co</strong> to your email whitelist to
							ensure you receive our emails.
						</Text>
						<Hr />
						<Text className="text-sm leading-6 text-black">
							Along with the rebrand, we&apos;ve also been working on a
							multitude of new features. In the last 30 days, we rolled out 9
							major updates:
						</Text>
