export { type Site as SiteProps } from "@prisma/client";

export interface SimpleSiteProps {
  domain?: string;
  key: string;
  url: string;
}
...
export interface WorkspaceWithDomainProps extends WorkspaceProps {
  domains: DomainProps[];
...
export interface UserProps {
  ...
  sites?: { domain: string; key: string; url: string }[];
}
